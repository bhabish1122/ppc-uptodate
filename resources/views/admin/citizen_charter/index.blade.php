      ...
      <section class="col-lg-12 connectedSortable">
        ...
        <div class="card">
          <div class="card-header">
            <div class="row">
              <div class="col-md-2">
                <a href="{{ route('admin.citizen_charter.create')}}" class="btn btn-sm btn-primary text-capitalize rounded-0" data-toggle="tooltip" data-placement="top" title="Add CitizenCharter  ">Add <i class="fas fa-user-plus fa-fw"></i> </a>
...
<script type="text/javascript">
  ...
  function searchFunction(){
    ...
    var table = $('.yajra-datatable').DataTable({
        ...
        serverSide: true,
        "ajax": {
          "url": "{{route('admin.getCitizenCharterList')}}",
          "data": {
          }
        },
        columns: [
