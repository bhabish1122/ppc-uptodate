  ...
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6 pl-1">
        <h1 class="text-capitalize">Add Quick Menu</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{route('admin.home')}}">Home</a></li>
          <li class="breadcrumb-item active text-capitalize">Quick Menu</li>
        </ol>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <form role="form" enctype="multipart/form-data" method="POST" action="{{route('admin.quick_menu.store')}}">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="link">Link <code>* https://www.Your_Path.com</code></label>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Add Quick Menu</button>
                </div>
              </form>
