  ...
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6 pl-1">
        <h1 class="text-capitalize">Add VideoGallery </h1>
      </div>
      <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <form role="form" enctype="multipart/form-data" method="POST" action="{{route('admin.video-gallery.store')}}">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                   <label for="link">Link <code>*</code></label>
                    <input type="text" class="form-control" id="link" placeholder="Add New Title" name="link" autocomplete="off">
                    @error('link')
                    <span class="text-danger font-italic" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Add VideoGallery </button>
                </div>
              </form>
