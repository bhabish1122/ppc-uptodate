...
<div id="login-box">
    <div class="logo">
        {{-- <img src="{{URL::to('/')}}/logins/img/namaste.png" class="img-fluid img-circle mx-auto d-block" style="width:20%;" /> --}}
        <img src="{{URL::to('/')}}/web/images/icon-dwri.png" class="img-fluid img-circle mx-auto d-block" style="width:20%;" />
    ...
    {{-- <div class="text-center" style="color: white; margin-top: 10%; font-size: x-small; ">
        <small> Develop by<a href="https://techware.com.np/" target="_blank" class="color-hyper"> Techware Pvt. Ltd</a></small>
    </div> --}}
</div>
@endsection
@push('javascript')
