...
<div class="container-fluid">
    ...
    @if(count($slider_top))
<div class="site-section pt-1 pb-1 main-n-m-t">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-10">
                @foreach($abouts as $about)
                <div class="no-gutters align-items-stretch bg-light">
                    <div class="p-3 main-about-text" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="float-right text-dark mt-4">
                            ...
                            <a class="fade00" href="{{ route('web.aboutUs.detail') }}">
                                {{ __('lang.explose_more')}}
                                <i class="fa fa-arrow-right"></i>
                                <span class="bg"></span>
                            </a>
            ...
            @if ($cores)
            <div class="col-lg-2 main-mt-sm-4 mt-xs-4">

                <!-- <div class="mb-4 d-flex justify-content-end" data-aos="fade-up" data-aos-delay="300">
                    <div class="card" style="width:253px;">
                        <a href="{{ route('web.about.list-of-director-generals.show',$cores->id) }}"
                            class="text-hover-a">
                            <img src="{{ url($cores->image_enc ? 'image/core_person/thumbnail/'.$cores->image_enc : 'image/noimage.png') }}"
                                class="img-fluid mx-auto w-75 rounded card-img-top" alt="{{ $cores->name }}">
                        </a>
                        <div class="card-body text-center">
                            <h6 class="card-title font-weight-bold text-primary m-0">
                                <a
                                    href="{{ route('web.about.list-of-director-generals.show',$cores->id) }}">{{ $cores->name }}</a>
                            </h6>
                        ...
                        <div class="card" style="width: 10rem;">
                            <a href="{{ route('web.about.list-of-director-generals.show',$cores_sub_record->id) }}"
                                ...
                                <img src="{{ url($cores_sub_record->image_enc ? 'image/core_person/thumbnail/'.$cores_sub_record->image_enc : 'image/noimage.png') }}"
                                    class="card-img-top" alt="{{ $cores_sub_record->name }}">
                            </a>
                            <div class="card-body text-center">
                                <h6 class="card-title font-weight-bold text-primary m-0">
                                    <a
                                        href="{{ route('web.about.list-of-director-generals.show',$cores_sub_record->id) }}">{{ $cores_sub_record->name }}</a>
                                </h6>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="no-gutters align-items-stretch">
                                <div class="main-about-text" data-aos="fade-up" data-aos-delay="100">
                                    <h2 class="site-section-heading text-uppercase font-secondary mb-5">{{$about->name}}
                                    </h2>
                                    {!! substr($about->description,0,800) !!}
                        ...
                        <div
                            ...
                            <div class="tile" id="tile-1" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <ul class="nav nav-tabs nav-justified overflow-auto" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" id="general-1" data-toggle="tab" href="#general"
                                            role="tab" aria-controls="general"
                                            aria-selected="false">{{ __('lang.notice')}}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="procurement-2" data-toggle="tab" href="#procurement"
                                            role="tab" aria-controls="procurement"
                                            aria-selected="true">{{ __('lang.procurement_notice')}}</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" id="notice-board-6" data-toggle="tab" href="#notice-board"
                                            role="tab" aria-controls="notice-board"
                      ...
                      <a class="nav-link" id="citizen-charter-tab" data-toggle="tab" href="#citizen-charter" role="tab" aria-controls="citizen-charter" aria-selected="false">{{ __('lang.citizen_charter')}}</a>
                                ...
                                <div class="tab-content">
                                                ...
                                                <div class="coupon bg-light rounded px-3 mb-3 d-flex justify-content-between border-dark coupon-shadow"
                                                    ...
                                                    <div class="py-3 w-100 justify-content-start">
                                                        <div class="d-block mr-2">
                                                            <h3 class="lead" data-toggle="tooltip" data-placement="top"
                                                                data-html="true"
                                  ...
                                  <div class="clearfix"></div>
                                        ...
                                        <div class="float-right">
                                            <a class="fade00" href="{{ route('web.notice.index', 'general-notice') }}">
                                                {{ __('lang.explose_more')}}
                                                <i class="fa fa-arrow-right"></i>
                                    ...
                                    <div class="tab-pane fade" id="posting-notice" role="tabpanel"
                                        ...
                                        <div class="float-right">
                                            <a class="fade00" href="{{ route('web.notice.index', 'posting-notice') }}">
                                                {{ __('lang.explose_more')}}
                                                <i class="fa fa-arrow-right"></i>
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    <div class="media">
                                                        <img src="{{URL::to('/')}}/image/division_section/thumbnail/{{$section_list->image_enc}}"
                                                            class="img-fluid mr-3" alt="{{$section_list->title}}"
                                                            width="25%">
                            ...
                            <ul class="list-group list-group-flush flush-border list-arrow">
                                ...
                                <li class="list-group-item px-0" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <a class="text-dark"
                                        ...
                                        target="{{$aayojan->link ? '_blank' : '_self'}}">{!! $aayojan->title !!}<i
        ...
        <div class="block-grid">
            <div class="row">
                <div class="col-md mb-3 col-6">
                    <div class="card text-center gradient-bg text-light">
                        <i class="fa fa-3x fa-comments"></i>
                        <h5 class="fs-6" style="color:#f8f9fa;"> <a href="#" class="text-light"> BLOCK TEST </a></h5>
                    </div>
                </div>
                <div class="col-md mb-3 col-6">
                    <div class="card text-center gradient-bg text-light">
...
<div class="container-fluid site-section py-1">
    <div class="container-fluid">
        <div class="row">
